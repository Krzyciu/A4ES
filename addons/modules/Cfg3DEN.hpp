class Cfg3DEN {
    class Attributes {
        ...
        #include "attributes\dynamicToolboxActionType.hpp"
        #include "attributes\dynamicToolboxActionConditionType.hpp"
        ...
        #include "attributes\dynamicOwnerNoSyncToolbox.hpp"
        ...
        #include "modules\setAnimation\attributes\mode.hpp"
    };
    class EventHandlers {
        class ADDON {
            ...
            onMissionSave = QUOTE(call FUNC(handleMissionSave));
        };
    };
    class Mission {
        class Preferences {
